...
export default function Home() {
  return (
    <main>
      ...
      <div className={`absolute top-[25%] left-[10%] right-[10%] w-[80%] h-[65%] outline outline-cyan-700 p-[1%] ${lusitana.className} text-[200%] text-black`}>
        This year's competition is set to take place Spring 2025 both virtually and at in-person sites. <br></br>
        Information on our in-person sites and awards can be found on our Contest Information page.

        <br></br>
        <br></br>
        <br></br>

        Final contest results will be available later on our Results page.
      ...
      <div className={`absolute bottom-[1%] left-[10%] right-[10%] w-[80%] h-[10%] flex items-center justify-left text-[150%] ${lusitana.className} text-gray-400`}>
